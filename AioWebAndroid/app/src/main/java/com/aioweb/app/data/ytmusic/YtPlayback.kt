...
import com.aioweb.app.data.downloads.MusicExoDownloadService
import com.aioweb.app.data.downloads.YtMusicDownloadUtil
...
object YtPlayback {
    ...
    fun isDownloaded(context: Context, song: YtmSong): Boolean {
        ...
        val legacyFile = com.aioweb.app.data.downloads.MusicDownloader.isDownloaded(context, url)
        return legacyFile
    }
}
