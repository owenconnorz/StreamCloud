...
**How to apply:** Any future stream-cache, playback retry, or persistence change must share the same expiry check and rejection eviction behavior for both in-memory and persisted entries.